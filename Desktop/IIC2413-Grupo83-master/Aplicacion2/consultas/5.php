   ...
   <body class="home" id="page">
      ...
      <div class="content-box">
         ...
         <section class="section section-hero">
            ...
            <div class="contenedor" style="width:90%; margin-left: 5%">
        <table class="table table-hover table-dark table-fixed">
            <thead>
                <tr style="width: 680px">
                <th style="width: 200px" scope="col">Identificador Usuario</th>
                <th style="width: 200px" scope="col">Nombre Usuario</th>
                <th style="width: 200px" scope="col">Fecha Ingreso</th>
                <th style="width: 200px" scope="col">Fecha Salida</th>
                <th style="width: 200px" scope="col">Nombre Hotel</th>
                </tr>
            </thead>
            <tbody>
            <?php require_once 'obtener_datos_5.php' ?>
            </tbody>
        </table>
    </div>
            </div>
