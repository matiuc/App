            ...
            <div class="container">
               ...
               <div class="container">
                  ...
                  <form class="destinations-form" action="consultas/4.php" method="get">
                     <div class="input-line">
                     <input type="text" name="pregunta2" value="" class="form-input check-value" placeholder="Filtrar dinero gastado por usuario en tickets. Ingrese id de usuario:" />
                        <button type="submit" name="enviado2" class="form-submit btn btn-special">Filtrar</button>
                     </div>
               ...
               <div class="container">
                  ...
                  <form class="destinations-form" action="consultas/5.php" method="get">
                     <div class="input-line">
                     <input type="text" name="pregunta2" value="Filtrar reservas desde el 01/01/2020 - 31/03/2020" class="form-input check-value" placeholder="" disabled/>
                        <button type="submit" name="enviado2" class="form-submit btn btn-special">Filtrar</button>
                     </div>
               ...
               <div class="container">
                  ...
                  <form class="destinations-form" action="consultas/6.php" method="get">
                     <div class="input-line">
                     <input type="text" name="pregunta2" value="" class="form-input check-value" placeholder="Filtrar dinero gastado en tickets por usuario entre fechas. Ingrese fecha inicio y fecha fin." />
                        <button type="submit" name="enviado2" class="form-submit btn btn-special">Filtrar</button>
                     </div>
